...
Sequel.migration do
  up do
    ...
    create_table(:accounts) do
      ...
      uuid :public_id, default: Sequel.function(:gen_random_uuid)
      String :full_name, null: :false, defualt: ""
      String :role, null: :false, default: "worker"
      DateTime :created_at, :null=>false, :default=>Sequel::CURRENT_TIMESTAMP
      index :public_id, :name=>:account_public_id_idx
      index :created_at, :name=>:account_created_at_idx
    end
